...
export default function Landing() {
  return (
    <div className="min-h-screen bg-background text-foreground [overflow-x:clip]">
      ...
      {/* HERO */}
      <section className="relative pt-32 pb-24 md:pt-40 md:pb-32 bg-grid overflow-hidden">
        <div className="absolute inset-0 bg-hero-glow pointer-events-none" />
        <div className="relative max-w-5xl mx-auto px-5 text-center">
          <span className="animate-fade-up inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-border bg-card/60 text-xs text-muted-foreground mb-8">
            <Sparkles size={14} className="text-accent" />
            AI-powered Community Operating System
          </span>
          <h1
            className="animate-fade-up [animation-delay:150ms] font-display font-bold leading-[1.05] tracking-tight"
          ...
          <p className="animate-fade-up [animation-delay:300ms] mt-7 max-w-2xl mx-auto text-base md:text-lg text-muted-foreground leading-relaxed">
          ...
          <div className="animate-fade-up [animation-delay:450ms] mt-10 flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <AnimateOnScroll key={i} delay={i * 120}>
                <div className="rounded-xl border border-border bg-card/60 p-7 hover:border-primary/40 transition h-full">
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <AnimateOnScroll key={i} delay={i * 120}>
                <div className="rounded-2xl border border-border bg-card p-8 hover:border-primary/50 hover:shadow-[0_0_40px_oklch(0.65_0.22_290/0.15)] transition group h-full">
                  <div
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <AnimateOnScroll key={i} delay={i * 120}>
                <div
                  className={`relative rounded-2xl p-8 flex flex-col h-full ${p.popular ? "border-2 border-primary bg-card glow-primary" : "border border-border bg-card/60"}`}
                >
                  {p.popular && (
